...
\usepackage{tikz}
\usepackage{titling}
\usepackage{array} % Para mejorar el manejo de columnas
\usepackage{graphicx}
\usepackage{fancyhdr}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{multicol}
\usepackage{cancel}
\usepackage{subcaption} % Para subtítulos de tablas
\usepackage{float} % Para el manejo de posiciones de tablas
\usepackage{pgfplots}
\usepackage{hyperref}
